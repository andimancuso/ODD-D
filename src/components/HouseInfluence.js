...
export class HouseInfluence extends React.Component {
  render() {
    ...
    return (
      <span>
        The noble house as a whole has {influence} influence on its neighboring nobility and its sovereign, which heavily influences how much or little the house and its members can accomplish politically and socially.
      </span>
    );
  };
};
